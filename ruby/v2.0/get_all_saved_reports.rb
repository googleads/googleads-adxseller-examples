...
#
# This example gets all the saved reports for the logged in user's account.
#
...
def get_all_saved_reports(adexchangeseller)
  request = adexchangeseller.accounts.reports.saved.list(
...
if __FILE__ == $0
  ...
  get_all_saved_reports(adexchangeseller)
end
