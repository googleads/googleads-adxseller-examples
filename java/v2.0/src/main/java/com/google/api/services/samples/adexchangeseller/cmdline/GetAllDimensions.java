...
public class GetAllDimensions {
  ...
  public static void run(AdExchangeSeller adExchangeSeller, String accountId) throws Exception {
    System.out.println("=================================================================");
    System.out.println("Listing all dimensions for the specified account");
    System.out.println("=================================================================");

    // Retrieve and display dimensions.
    Metadata dimensions = adExchangeSeller.accounts().metadata().dimensions()
    ...
    if (dimensions.getItems() != null && !dimensions.getItems().isEmpty()) {
      for (ReportingMetadataEntry dimension : dimensions.getItems()) {
        ...
        System.out.printf("Dimension id \"%s\" for product(s): [%s] was found.%n",
