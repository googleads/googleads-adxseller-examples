...
public class GetAllPreferredDeals {
  ...
  public static void run(AdExchangeSeller adExchangeSeller, String accountId) throws Exception {
    System.out.println("=================================================================");
    System.out.println("Listing all preferred deals the specified account");
    System.out.println("=================================================================");

    // Retrieve and display preferred deals.
    PreferredDeals deals = adExchangeSeller.accounts().preferreddeals().list(accountId).execute();
