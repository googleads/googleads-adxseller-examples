...
public class GetAllUrlChannels {
  ...
  public static void run(AdExchangeSeller adExchangeSeller, String accountId,
    ...
    System.out.println("=================================================================");
    System.out.printf("Listing all URL channels for the specified account %s%n", adClientId);
    System.out.println("=================================================================");

    // Retrieve URL channel list in pages and display the data as we receive it.
    String pageToken = null;
    do {
      UrlChannels urlChannels = adExchangeSeller.accounts().urlchannels()
          .list(accountId, adClientId)
      ...
      if (urlChannels.getItems() != null && !urlChannels.getItems().isEmpty()) {
        for (UrlChannel channel : urlChannels.getItems()) {
          System.out.printf("URL channel with URL pattern \"%s\" was found.%n",
