...
public class GetAllAdClients {
   ...
   * @throws Exception
   */
  public static AdClients run(AdExchangeSeller adExchangeSeller, String accountId, long maxPageSize)
      throws Exception {
    System.out.println("=================================================================");
    System.out.println("Listing all ad clients for the specified account");
    System.out.println("=================================================================");
    ...
    do {
      adClients = adExchangeSeller.accounts().adclients().list(accountId)
      ...
      if (adClients.getItems() != null && !adClients.getItems().isEmpty()) {
        for (AdClient adClient : adClients.getItems()) {
          System.out.printf("Ad client for product \"%s\" with ID \"%s\" was found.%n",
              adClient.getProductCode(), adClient.getId());
          System.out.printf("\tSupports reporting: %s%n",
