...
"""Auxiliary file for Ad Exchange Seller API code samples.
...
def prepare_credentials():
  ...
  storage = Storage('adexchangeseller.dat')
...
def retrieve_service(http):
  """Retrieves an Ad Exchange Seller API service via the discovery service."""

  # Construct a service object via the discovery service.
  service = build('adexchangeseller', 'v1', http=http)
